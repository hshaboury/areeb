...
export default function TopicsAnalysis() {
  ...
  // TODO: In the future, get actual analysis from API/state management based on quiz results
  const topicsData = mockTopicsAnalysis;
        ...
        <div className="max-w-[900px] w-full mx-auto mt-24">
          ...
          <div className="bg-white/5 border border-[#EAEDFA]/10 rounded-2xl p-6 backdrop-blur-sm mb-6">
            ...
            <p className="text-[#EAEDFA]/70">
              We&apos;ll help you create a personalized roadmap based on your schedule and learning goals.
            </p>
          </div>

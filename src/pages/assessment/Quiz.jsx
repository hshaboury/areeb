...
export default function Quiz() {
  ...
  // TODO: In the future, get the track from user context/state management
  const [track] = useState('frontend'); // Default track for now
  ...
  useEffect(() => {
    ...
    // based on the user's track and skill level
    const loadQuestions = async () => {
      setIsLoading(true);
      // Simulate API delay
      setTimeout(() => {
        const trackQuestions = getQuestionsByTrack(track);
